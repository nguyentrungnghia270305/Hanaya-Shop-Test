...
use Illuminate\Database\Eloquent\Factories\HasFactory; // Factory support for testing/seeding
use Illuminate\Database\Eloquent\Model;                // Base Eloquent model class
use App\Models\Order\OrderDetail;  // Order details for sales tracking
use App\Models\Product\Category;   // Product categories for organization
use App\Models\Cart\Cart;         // Shopping cart functionality
use App\Models\Product\Review;    // Customer reviews and ratings
