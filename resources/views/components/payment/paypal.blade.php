<div 
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-lg font-semibold">Thanh toán qua PayPal</h3>
            <img src="{{ asset('fixed_resources/payment/paypal.svg') }}" alt="PayPal" class="h-8">
        </div>

        <div class="text-center py-4">
            <p class="text-gray-600 mb-6">
                Bạn sẽ được chuyển đến trang web PayPal để hoàn tất thanh toán an toàn.
            </p>
            ...
            <div x-show="!isProcessing" class="flex justify-center">
                ...
                >
                    <span class="font-semibold">Thanh toán với</span>
            ...
            <div x-show="isProcessing" class="flex flex-col items-center justify-center">
                ...
                <p class="text-gray-600">Đang chuyển đến PayPal...</p>
            </div>
        </div>
        
        <div class="mt-6 border-t pt-4">
            <p class="text-xs text-gray-500 text-center">
                PayPal là cổng thanh toán trực tuyến an toàn và bảo mật. Bạn không cần tài khoản PayPal để thanh toán.
            </p>
        </div>
    </div>
</div>
