...
<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-12 px-4 space-y-10">
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            ...
            <textarea class="w-full p-2 border rounded" rows="4" placeholder="Nhập lời nhắn của bạn..."></textarea>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6">
            <div class="flex items-center justify-between flex-wrap gap-2 mb-4">
                ...
                <button class="bg-pink-600 text-white px-4 py-2 rounded hover:bg-pink-700 transition whitespace-nowrap">
                    Thay đổi
                </button>
            </div>
