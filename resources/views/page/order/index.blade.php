                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">${{ number_format($orders->sum('total_price')) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center space-x-2 mb-4">
                                            ...
                                            <div class="flex -space-x-2">
                                                @foreach($order->orderDetail->take(4) as $detail)
                                                    ...
                                                    @else
                                                        <div class="w-10 h-10 rounded-lg bg-gray-200 border-2 border-white shadow-sm flex items-center justify-center">
                                                ...
                                                @if($order->orderDetail->count() > 4)
                                                    <div class="w-10 h-10 rounded-lg bg-gray-100 border-2 border-white shadow-sm flex items-center justify-center">
                                                        <span class="text-xs font-medium text-gray-600">+{{ $order->orderDetail->count() - 4 }}</span>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                            <div class="bg-gray-50 rounded-lg p-3">
                                                ...
                                                <p class="text-lg font-bold text-gray-900">${{ number_format($order->total_price) }}</p>
                                            </div>
                                            <div class="bg-gray-50 rounded-lg p-3">
                                                <p class="text-xs font-medium text-gray-500 uppercase tracking-wide">Items</p>
                                                <p class="text-lg font-bold text-gray-900">{{ $order->orderDetail->count() }} {{ $order->orderDetail->count() === 1 ? 'item' : 'items' }}</p>
                                            </div>
                                            <div class="bg-gray-50 rounded-lg p-3">
