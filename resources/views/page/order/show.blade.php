                ...
                <div class="py-6">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="text-pink-100 mt-2">Order #{{ $order->id }} - {{ $order->created_at->format('M d, Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col items-center flex-1">
                        ...
                        <p class="text-sm font-medium mt-2 text-center {{ $currentStep >= 1 ? 'text-blue-600' : 'text-gray-500' }}">Processing</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center flex-1">
                        ...
                        <p class="text-sm font-medium mt-2 text-center {{ $currentStep >= 2 ? 'text-green-600' : 'text-gray-500' }}">Confirmed</p>
                    </div>
                    ...
                    <div class="flex flex-col items-center flex-1">
                        ...
                        <p class="text-sm font-medium mt-2 text-center {{ $currentStep >= 3 ? 'text-purple-600' : 'text-gray-500' }}">Delivered</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-200">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-3 border-b border-gray-200">
                            ...
                            <span class="font-semibold text-gray-900">{{ $order->created_at->format('M d, Y H:i') }}</span>
                        </div>
                        <div class="flex justify-between items-center py-3 border-b border-gray-200">
                    ...
                    @foreach ($order->orderDetail as $detail)
                        <div class="p-6 hover:bg-gray-50 transition-colors">
                            <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
                                <!-- Product Image -->
                                <div class="flex-shrink-0">
                                    <a href="{{ route('user.products.show', $detail->product_id) }}" class="block group">
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-base font-medium text-gray-900">${{ number_format($order->total_price - config('constants.checkout.shipping_fee', 8)) }}</span>
                        </div>
                        
                        <!-- Shipping Fee -->
                        <div class="flex justify-between items-center">
                            <span class="text-base text-gray-700">Shipping Fee:</span>
                            <span class="text-base font-medium text-gray-900">${{ number_format(config('constants.checkout.shipping_fee', 8)) }}</span>
                        </div>
                        ...
                        <div class="border-t border-gray-300 pt-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-2xl font-bold text-purple-600">${{ number_format($order->total_price) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
