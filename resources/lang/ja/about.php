...
return [
    ...
    'sustainability_value' => '持続可能性',
    'sustainability_value_desc' => '環境に優しい材料と持続可能な実践を優先します。',
    'creativity_value' => '創造性',
    ...
    'best_soap_flower_award' => '2023年最優秀ソープフラワーブランド',
    ...
    'how_we_work' => '私たちの働き方',
    'design_phase' => 'デザインフェーズ',
    'design_phase_desc' => 'クリエイティブチームが独特で美しいソープフラワーアレンジメントをデザインします。',
    'crafting_phase' => 'クラフトフェーズ',
    'crafting_phase_desc' => '熟練した職人が細部にこだわって各ソープフラワーを手作りします。',
    ...
    'product_care_faq' => 'ソープフラワーのお手入れ方法は？',
    ...
    'contact_for_custom' => 'カスタムオーダーのお問い合わせ',
    'join_newsletter' => 'ニュースレターに参加',
];
